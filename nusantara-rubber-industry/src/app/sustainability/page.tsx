...
export default function SustainabilityPage() {
  return (
    <div className="relative min-h-screen bg-background font-sans overflow-x-hidden">
      ...
      <section id="sustainability-main" className="relative py-12 border-t border-border/40">
        <SustainabilitySection />
      </section>

      {/* Section 2: Certificates */}
      <section id="sustainability-certificate" className="relative py-20 border-t border-border/40 bg-elevated/10">
      ...
      <section id="sustainability-customers" className="relative py-20 border-t border-border/40">
      ...
      <section className="relative py-20 border-t border-border/40 bg-elevated/25">
        <div className="max-w-5xl mx-auto px-6">
