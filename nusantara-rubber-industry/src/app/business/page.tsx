...
export default function BusinessPage() {
  return (
    <div className="relative min-h-screen bg-background font-sans overflow-x-hidden">
      ...
      <section id="business-process" className="relative py-12 border-t border-border/40">
        <BusinessSection />
      </section>
      
      {/* Section 2: Products Catalog */}
      <section id="business-products" className="relative py-12 border-t border-border/40 bg-elevated/10">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col gap-2 mb-8">
            <span className="text-xs font-semibold uppercase tracking-widest text-rubber-red-light font-mono">
              IKN Catalog Store
            </span>
            <h2 className="text-2xl font-bold text-foreground sm:text-3xl">Pilih Produk Karet Spesifikasi Industri</h2>
          </div>
        </div>
        <ProductsSection />
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center mt-2">
              <Link
                href="/business/ecommerce/dummy-form"
                className="btn-primary px-8 py-3 text-xs flex items-center justify-center gap-2"
              >
                Minta Quotation B2B <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
