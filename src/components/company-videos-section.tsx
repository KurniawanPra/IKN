...
export default function CompanyVideosSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 md:py-20 lg:py-30 w-full flex flex-col justify-center min-h-full h-auto gap-6 sm:gap-8 lg:gap-10">
